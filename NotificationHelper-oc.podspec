#
#  Be sure to run `pod spec lint NotificationHelper-oc.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/ruixiaoguo/NotificationHelper.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "NotificationHelper/NotificationHelper/*.{h,m}"
  s.exclude_files = ""
